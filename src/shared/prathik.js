...
import {FaPython,FaJs,FaHtml5,FaCss3Alt,FaBootstrap,FaLaptopCode,FaNodeJs,FaReact,FaEthereum,FaSuitcase,FaHackerrank,FaLinkedin,FaGithubSquare} from 'react-icons/fa';
        ...
        experience:[
            {
                ...
                start: 'June 2021',
                End: 'Present',
                description:`Part of Group Operations IB division.

                Worked with tools like ARIS to reduce the number of manual work and improve the number of works to be automated.
                
                Working in Alteryx for designing the workflow of the data which can ultimately be used to analyze. 
                `
            },
            {
                id:1,
